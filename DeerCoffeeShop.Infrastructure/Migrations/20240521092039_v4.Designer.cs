            ...
            modelBuilder.Entity("DeerCoffeeShop.Domain.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = "1",
                            Address = "HCM",
                            DateJoined = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4363),
                            DateOfBirth = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4362),
                            Email = "Admin@gmail.com",
                            EmployeeID = 1,
                            FullName = "Admin",
                            IsActive = true,
                            IsDeleted = false,
                            NgayCapNhatCuoi = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4359),
                            NgayTao = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4364),
                            NguoiTaoID = "1",
                            Password = "123456",
                        ...
                        new
                        {
                            ID = "2",
                            Address = "HCM",
                            DateJoined = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4397),
                            DateOfBirth = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4397),
                            Email = "Manger@gmail.com",
                            EmployeeID = 2,
                            FullName = "Manger",
                            IsActive = true,
                            IsDeleted = false,
                            NgayCapNhatCuoi = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4396),
                            NgayTao = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4398),
                            NguoiTaoID = "1",
                            Password = "123456",
                            PhoneNumber = "0123456789",
                            RefreshToken = "",
                        ...
                        new
                        {
                            ID = "3",
                            Address = "HCM",
                            DateJoined = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4402),
                            DateOfBirth = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4402),
                            Email = "Employee3@gmail.com",
                            EmployeeID = 3,
                            FullName = "Employee3",
                            IsActive = true,
                            IsDeleted = false,
                            NgayCapNhatCuoi = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4401),
                            NgayTao = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4403),
                            NguoiTaoID = "1",
                            Password = "123456",
                            PhoneNumber = "0123456789",
                            RefreshToken = "",
                        ...
                        new
                        {
                            ID = "4",
                            Address = "HCM",
                            DateJoined = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4407),
                            DateOfBirth = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4406),
                            Email = "Employee4@gmail.com",
                            EmployeeID = 4,
                            FullName = "Employee4",
                            IsActive = true,
                            IsDeleted = false,
                            NgayCapNhatCuoi = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4405),
                            NgayTao = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4407),
                            NguoiTaoID = "1",
                            Password = "123456",
                            PhoneNumber = "0123456789",
                            RefreshToken = "",
                        ...
                        new
                        {
                            ID = "5",
                            Address = "HCM",
                            DateJoined = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4411),
                            DateOfBirth = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4410),
                            Email = "Employee5@gmail.com",
                            EmployeeID = 5,
                            FullName = "Employee5",
                            IsActive = true,
                            IsDeleted = false,
                            NgayCapNhatCuoi = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4409),
                            NgayTao = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4412),
                            NguoiTaoID = "1",
                            Password = "123456",
                            PhoneNumber = "0123456789",
                            RefreshToken = "",
            ...
            modelBuilder.Entity("DeerCoffeeShop.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Name = "Admin",
                            NgayTao = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4135),
                            NguoiTaoID = "1"
                        },
                        new
                        {
                            ID = 2,
                            Name = "Manger",
                            NgayTao = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4151),
                            NguoiTaoID = "1"
                        },
                        new
                        {
                            ID = 3,
                            Name = "Employee",
                            NgayTao = new DateTime(2024, 5, 21, 16, 20, 38, 777, DateTimeKind.Local).AddTicks(4153),
                            NguoiTaoID = "1"
                        });
                });
